...
public partial class TableView : IDisposable 
{
    ...
    public object RefreshData(List<object> entries, Dictionary<object, Color> specialTextColors = null)
    {
        m_lines.Clear();
        ...
        //{
            ...
            //{
               ...
               //DrawTitle(r.width);
                ...
                int firstLine = Mathf.Max((int)(_scrollPos.y / _appearance.LineHeight), 0);
