...
public class FooItem
{
    ...
    public static FooItem MakeRandom()
    {
        return new FooItem()
        {
            ...
            Percent = (int)(Random.value*10.0f)+" %",
...
public class TableViewDemoWindow 
{
    ...
    /*void Awake()
    {
        ...
        _table.AddColumn("Size", "Size", 0.25f, TextAnchor.MiddleCenter, "0.000");
        _table.AddColumn("Percent", "Percent", 0.25f);
